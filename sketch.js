...
function setup() {
    ...
    let credits = createP("Source Code: <a href='https://github.com/AssassinLYZ/pathFind' target='_blank'>Eric Liu</a>")
...
const reset = () => {
    ...
    timeP.elt.innerText = 'Time used: 0s'
